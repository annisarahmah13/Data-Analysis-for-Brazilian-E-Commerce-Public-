with table1 as(select orders.order_id,count(product_id) as product_num,date(order_estimated_delivery_date) as estimated,date(order_delivered_customer_date) as delivered,
...
end as status_delivery,sum(product_num) as product_num,
